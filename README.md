...
- [Recommend](/ml/04_recommend.py) 
 ...
 #### Algorithms 
- [Moores voting algorithm](/Algorithms/01_moores_voting_algorithm.py) 
- [Kadanes algorithm](/Algorithms/02_kadanes_algorithm.py) 
...
- [Right angle triangle pattern](/pattern_problems/02_right_angle_triangle_pattern.py) 
- [Star pyramid](/pattern_problems/07_star_pyramid.py) 
- [Right angled numbered pyramid](/pattern_problems/03_right_angled_numbered_pyramid.py) 
